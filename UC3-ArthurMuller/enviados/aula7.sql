...
-- Exercicio 4
SELECT nome, preco FROM produtos WHERE preco ORDER BY preco ASC LIMIT 3;

-- Exercicio 5
SELECT nome FROM clientes WHERE cidade = 'Porto Alegre' OR cidade = 'Canoas';

-- Exercicio 6
SELECT nome, cidade FROM clientes WHERE cidade = 'Canoas';

-- Exercicio 7
SELECT * FROM clientes WHERE idade BETWEEN 30 AND 40;

-- Exercicio 8
SELECT nome, preco FROM produtos WHERE nome LIKE '%Note%';

-- Exercicio 9
SELECT * FROM clientes WHERE cidade = 'Porto Alegre' OR cidade = 'São Paulo' OR cidade = 'Curitiba';

-- Exercicio 10
SELECT * FROM produtos WHERE categoria = 'Games' ORDER BY preco DESC;

-- Exercicio 11
SELECT * FROM produtos WHERE preco ORDER BY preco DESC LIMIT 5;

-- Exercicio 12
SELECT nome,idade,cidade FROM clientes WHERE idade ORDER BY idade ASC LIMIT 5;

-- Exercicio 13
SELECT * FROM produtos WHERE preco < 100;

-- Exercicio 14
SELECT nome, categoria FROM produtos WHERE preco > 1000 AND categoria = 'Informática' OR categoria = 'Eletrônicos';
...
-- Exercicio 17
SELECT * FROM produtos WHERE preco NOT BETWEEN 200 AND 800;